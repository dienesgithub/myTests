...
public class MagaluTest {
	...
	public void acessarPortal() throws InterruptedException {
		...
		Thread.sleep(10000);
		WebElement produtoSacola = driver.findElement(By.xpath("//*[@id='root']/div/div[2]/div/div[2]/div/div[2]/div[2]/div/div/div[1]/div/a/p[1]"));
		assertTrue("O produto esperado na sacola: " + primeiroProduto + " é diferente do obtido: " + produtoSacola.getText(), produtoSacola.getText().contentEquals(primeiroProduto));	
